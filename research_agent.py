...
def compress_research(state: ResearcherState) -> dict:
    ...
    curr_research_human_message = compress_research_human_message.format(research_topic=state.get("research_topic", ""))
    messages = [SystemMessage(content=system_message)] + state.get("researcher_messages", []) + [HumanMessage(content=curr_research_human_message)]
